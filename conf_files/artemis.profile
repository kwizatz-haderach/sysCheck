...
ARTEMIS_HOME='/opt/atar/artemis'
ARTEMIS_INSTANCE='/opt/atar/artemis-broker'
ARTEMIS_DATA_DIR='/opt/atar/artemis-broker/data'
ARTEMIS_ETC_DIR='/opt/atar/artemis-broker/etc'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/opt/atar/artemis-broker/'
ARTEMIS_INSTANCE_ETC_URI='file:/opt/atar/artemis-broker/etc/'
...
#if [ "$1" = "run" ]; then
JAVA_ARGS="$JAVA_ARGS -Dcom.sun.management.jmxremote=false -Dcom.sun.management.jmxremote.port=1099 -Dcom.sun.management.jmxremote.rmi.port=1099 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false"
#fi
